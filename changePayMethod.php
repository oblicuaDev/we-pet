...
<main>
  <div class="container">
    ...
    >
      <form action="p/changePlanNoCard/" id="creditcardChange" method="POST">
        <h2><?=$wp->findUiWord(299)?></h2>
        ...
        >
        <input type="hidden" name="planID" id="planID" value="<?=$_SESSION["user"]->plan->id?>"
        /> <input type="hidden" name="planType" id="planType" value="<?=$_SESSION["user"]->plan_type?>"
        />
